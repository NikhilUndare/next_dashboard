  ...
  return (
    <div className='w-screen  flex justify-center mt-40' >
       ...
       <h1 className='text-2xl text-center mb-6' >Login</h1>
        ...
        <input className=' darkbg p-4 rounded-md mb-5 border border-gray-500' type='text' placeholder='username' name='username' />
        <input className=' darkbg p-4 rounded-md mb-5 border border-gray-500' type='password' placeholder='password' name='password' />
